        ...
        <div className={styles.cartPage__content}>
          ...
          <div className={styles.checkout}>
            ...
            </div>
            {
              ...
              <div className={styles.checkout__attention}>
                ...
                <p style={{fontSize: '15px'}}>
                  {`Задля оформлення замовлення на доставку додайте ще на ${300 - commonSum} грн.`}
                </p>
              </div>
                :
            ...
            <div className={styles.checkout__buttons}>
              <button className={`${styles.checkout__button} ${styles.checkout__button_selfPickup}`}>
                Самовивіз
              </button>
              {
                commonSum >= 300
                  &&
                <button className={`${styles.checkout__button} ${styles.checkout__button_delivery}`}>
                  Доставка
                </button>
              }
            </div>
